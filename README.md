...
| 13 | 11/20 | **Lec8** Sequential Models [slides](https://github.com/inf16nyu/home/blob/master/slides/lecture8.pdf) <br /><br />**No lab this week** | Murphy, Secs. 19.5 & 19.6 <br /> [Notes on pseudo-likelihood](http://cs.nyu.edu/~dsontag/courses/inference15/slides/pseudolikelihood_notes.pdf) <br /> [An Introduction to Conditional Random Fields](http://arxiv.org/pdf/1011.4088v1) (section 4; optional) <br /> [Approximate maximum entropy learning in MRFs](http://arxiv.org/abs/1206.3257) (optional) | |
| 14 | 11/27 |  **Lec9** Modeling Images and High-dimensional data. Boltzmann Machines. Variational Autoencoders [slides](https://github.com/inf17nyu/home/blob/master/slides/lecture9.pdf) |  | [PS6](https://github.com/inf17nyu/home/blob/master/hw/ps7/), due 12/5 |
